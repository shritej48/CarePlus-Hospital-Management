...
const StaffAppointments = () => {
  ...
  const styles = {
    container: { maxWidth: '1400px', margin: '40px auto', padding: '24px', background: 'white', borderRadius: '24px', boxShadow: '0 8px 24px rgba(0,0,0,0.1)' },
  ...
  if (!staff) {
    return <div style={styles.container}>Please login as staff to view appointments.</div>;
  }
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>📋 All Appointments (Staff View)</h2>
      <p style={styles.subtitle}>View and manage all appointments across all doctors</p>
      {appointments.length === 0 ? (
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={styles.table}>
            <thead>
              <tr>
                <th style={styles.th}>Doctor</th><th style={styles.th}>Patient</th><th style={styles.th}>Date</th>
                <th style={styles.th}>Time</th><th style={styles.th}>Symptoms</th><th style={styles.th}>Status</th><th style={styles.th}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {appointments.map(apt => (
                <tr key={apt.id}>
                  <td style={styles.td}>{apt.doctorName}</td>
